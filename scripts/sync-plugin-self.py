...
def authoritative_text(version, stats):
    ...
    return (
        ...
        f"INSTALL (current): clone github.com/{REPO} and add it as a local "
        f"marketplace, then `/plugin install n8n-knowledge@n8n-knowledge-local`; a "
        f"public one-command marketplace listing is pending review. The plugin has "
